...
const ApprovalSidebar: React.FC<SidebarProps> = ({ 
  ...
  return (
    <div className="bg-gradient-to-b from-slate-800 to-slate-900 text-white w-64 min-h-screen fixed left-0 top-0 z-40 shadow-xl">
      {/* Logo and Title */}
      <div className="p-6 border-b border-slate-700">
        <Link href="/approval-dashboard" className="flex items-center space-x-3 group">
          ...
          <div>
            <h1 className="text-xl font-bold">Bizloan</h1>
            <p className="text-sm text-slate-300">Approval Dashboard</p>
          </div>
        </Link>
      </div>
            ...
            return (
              <li key={item.id}>
                ...
                >
                  ...
                  {item.badge && (
                    <span 
                      className={`${item.badgeColor} text-white text-xs px-2 py-1 rounded-full font-semibold min-w-[20px] text-center`}
                    >
                      {item.badge}
                    </span>
                  )}
      ...
      <div className="absolute bottom-6 left-4 right-4 space-y-2">
        ...
        <button
          ...
          className="w-full flex items-center space-x-3 p-3 rounded-lg text-slate-300 hover:bg-red-600 hover:text-white transition-all duration-200 group"
        >
        ...
        <Link
          href="/"
          className="flex items-center space-x-3 p-3 rounded-lg text-slate-300 hover:bg-slate-700 hover:text-white transition-all duration-200 group"
        >
