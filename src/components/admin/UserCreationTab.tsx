            ...
            <div className="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-10">
              ...
              <div className="flex items-center">
                <input
                  ...
                  name="role"
                  type="radio"
                  checked={formData.role === 'approval'}
                  onChange={() => handleRoleChange('approval')}
                  className="focus:ring-cyan-500 h-4 w-4 text-cyan-600 border-gray-300"
                />
                <label htmlFor="role-approval" className="ml-3 block text-sm font-medium text-gray-700">
                  Approval
                </label>
              </div>
            </div>
                    ...
                    <tr key={user._id || user.employeeId} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">
                        <span className={`px-2 py-1 text-xs font-medium rounded-full ${
                          ...
                          user.role === 'approval' ? 'bg-indigo-100 text-indigo-800' :
            ...
            <form onSubmit={handleUserDetailsUpdate} className="space-y-6">
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                <div className="space-y-4 sm:flex sm:items-center sm:space-y-0 sm:space-x-10">
                  ...
                  <div className="flex items-center">
                    <input
                      id="edit-role-approval"
                      name="editRole"
                      type="radio"
                      checked={editFormData.role === 'approval'}
                      onChange={() => handleEditRoleChange('approval')}
                      className="focus:ring-cyan-500 h-4 w-4 text-cyan-600 border-gray-300"
                    />
                    <label htmlFor="edit-role-approval" className="ml-3 block text-sm font-medium text-gray-700">
                      Approval
                    </label>
                  </div>
                </div>
