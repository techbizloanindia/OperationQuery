...
export type TabType = 'dashboard' | 'query-raised' | 'query-resolved' | 'sanctioned-cases' | 'add-query' | 'reports' | 'waiting-approval';
  ...
  const renderActiveTab = () => {
    switch (activeTab) {
      ...
      case 'waiting-approval':
        return <WaitingApproval key={refreshTrigger} />;
      default:
        return (
          <div className="space-y-6">
            <DashboardOverview />
