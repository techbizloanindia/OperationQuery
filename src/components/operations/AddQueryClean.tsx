                      ...
                      <div key={query.id} className="space-y-3">
                        ...
                        <div className="relative">
                          <button
                            ...
                            className="w-full p-4 bg-gray-50 border-2 border-gray-200 rounded-xl text-left hover:border-gray-300 focus:border-blue-500 focus:outline-none transition-all duration-200"
                          >
                          ...
                          {isQueryDropdownOpen[query.id] && (
                            <div className="absolute z-20 top-full mt-2 w-full bg-white rounded-xl shadow-xl border border-gray-200 max-h-80 overflow-y-auto">
                              {showBothTeams ? (
                                /* Both Teams Layout */
                                    ...
                                    <div className="max-h-64 overflow-y-auto">
                                      {salesQueries.map((salesQuery, idx) => (
                                        <button
                                          ...
                                          className="w-full p-3 text-left hover:bg-blue-50 border-b border-gray-100 text-sm transition-colors"
                                        >
                                          {salesQuery}
                                        </button>
                                      ))}
                                    ...
                                    <div className="max-h-64 overflow-y-auto">
                                      {creditQueries.map((creditQuery, idx) => (
                                        <button
                                          ...
                                          className="w-full p-3 text-left hover:bg-green-50 border-b border-gray-100 text-sm transition-colors"
                                        >
                                          {creditQuery}
                                        </button>
                                      ))}
                                ...
                                /* Single Team Layout */
                                <div>
                                  <div className={`${sendTo[0] === 'Sales' ? 'bg-blue-600' : 'bg-green-600'} text-white p-3 font-semibold text-center`}>
                                  ...
                                  <div className="max-h-64 overflow-y-auto">
                                    {(sendTo[0] === 'Sales' ? salesQueries : creditQueries).map((teamQuery, idx) => (
                                      <button
                                        ...
                                        className={`w-full p-3 text-left hover:${sendTo[0] === 'Sales' ? 'bg-blue-50' : 'bg-green-50'} border-b border-gray-100 text-sm transition-colors`}
                                      >
                                        {teamQuery}
                                      </button>
                                    ))}
                              ...
                              <button
                                ...
                                className="w-full p-3 text-left hover:bg-yellow-50 border-t-2 border-yellow-200 text-sm font-medium text-yellow-800 transition-colors"
                              >
                        ...
                        <textarea
                          ...
                          className="w-full h-32 p-4 border-2 border-gray-200 rounded-xl focus:border-blue-500 focus:outline-none resize-none transition-all duration-200"
                        />
                      </div>
                    ))}
